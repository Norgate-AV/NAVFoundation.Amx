PROGRAM_NAME='NAVSha512SigmaTests'

/*
 * Tests for the SHA-512 specific Sigma functions
 *
 * These tests verify that the SHA-512 specific Sigma functions work correctly:
...
#IF_NOT_DEFINED __NAV_SHA512_SIGMA_TESTS__
#DEFINE __NAV_SHA512_SIGMA_TESTS__ 'NAVSha512SigmaTests'
...
define_function integer TestSigmaBig0() {
    ...
    NAVErrorLog(NAV_LOG_LEVEL_DEBUG, "'Testing SHA-512 SigmaBig0 function'")
    ...
    NAVSha512SigmaBig0(value, actual)
...
define_function integer TestSigmaBig1() {
    ...
    NAVErrorLog(NAV_LOG_LEVEL_DEBUG, "'Testing SHA-512 SigmaBig1 function'")
    ...
    // Get actual result from function
    NAVSha512SigmaBig1(value, actual)
...
define_function integer TestSigmaSmall0() {
    ...
    NAVErrorLog(NAV_LOG_LEVEL_DEBUG, "'Testing SHA-512 SigmaSmall0 function'")
    ...
    // Get actual result from function
    NAVSha512SigmaSmall0(value, actual)
...
define_function integer TestSigmaSmall1() {
    ...
    NAVErrorLog(NAV_LOG_LEVEL_DEBUG, "'Testing SHA-512 SigmaSmall1 function'")
    ...
    // Get actual result from function
    NAVSha512SigmaSmall1(value, actual)
...
define_function integer TestCH() {
    ...
    NAVErrorLog(NAV_LOG_LEVEL_DEBUG, "'Testing SHA-512 CH function'")
...
define_function integer TestMAJ() {
    ...
    NAVErrorLog(NAV_LOG_LEVEL_DEBUG, "'Testing SHA-512 MAJ function'")
...
/**
 * @function RunNAVSha512SigmaTests
 * @description Run all SHA-512 Sigma function tests
 *
 * @returns {integer} 1 if all tests pass, 0 if any fail
 */
define_function integer RunNAVSha512SigmaTests() {
    stack_var integer success

    NAVErrorLog(NAV_LOG_LEVEL_DEBUG, "'****************** NAVSha512Sigma Tests ******************'")
    ...
    if (success) {
        NAVErrorLog(NAV_LOG_LEVEL_DEBUG, "'NAVSha512Sigma: All tests passed!'")
    } else {
        NAVErrorLog(NAV_LOG_LEVEL_ERROR, "'NAVSha512Sigma: Some tests failed!'")
    }

    return success
}

#END_IF // __NAV_SHA512_SIGMA_TESTS__
