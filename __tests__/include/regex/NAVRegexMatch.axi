...
constant char MATCH_TEST[][][50] = {
    ...
    { '/\d+/', '123', '3', '1', '4', '123', 'true' },
    { '/\w+/', 'abc', '3', '1', '4', 'abc', 'true' },
    { '/\w*/', 'abc', '3', '1', '4', 'abc', 'true' },
    { '/\s/', ' ', '1', '1', '2', ' ', 'true' },
    { '/\s+/', ' ', '1', '1', '2', ' ', 'true' },
    { '/\s*/', ' ', '1', '1', '2', ' ', 'true' },
    { '/\d\w?\s/', '1a ', '3', '1', '4', '1a ', 'true' },
    { '/\d\w\s+/', '1a ', '3', '1', '4', '1a ', 'true' },
    { '/\d?\w\s*/', 'a ', '2', '1', '3', 'a ', 'true' },
    { '/\D+/', 'abc', '3', '1', '4', 'abc', 'true' },
    { '/\D*/', 'abc', '3', '1', '4', 'abc', 'true' },
    { '/\D\s/', 'abc ', '2', '3', '5', 'c ', 'true' },
    { '/\W+/', ' ', '1', '1', '2', ' ', 'true' },
    { '/\S*/', 'abc', '3', '1', '4', 'abc', 'true' },
    { '/^[a-zA-Z0-9_]+$/', 'abc123_', '7', '1', '8', 'abc123_', 'true' },
    { '/^[Hh]ello,\s[Ww]orld!$/', 'Hello, World!', '13', '1', '14', 'Hello, World!', 'true' },
    // { '/^\d{3}-\d{2}-\d{4}$/', '123-45-6789', '11', '1', '12', '123-45-6789' },
    { '/^"[^"]*"/', '"abc"', '5', '1', '6', '"abc"', 'true' },
    // { '/^([a-zA-Z_]\w*)\s*=\s*([^;#].*)/', 'abc = def', '7', '1', '8', 'abc = def' },
    { '/.*/', 'abc', '3', '1', '4', 'abc', 'true' },
    { '/.*/', '', '0', '1', '1', '', 'true' },  // Should match epsilon
