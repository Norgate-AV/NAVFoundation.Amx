...
constant slong DIRECTORY_CREATE_EXPECTED_RESULT[] = {
    ...
    -8,     // Test 3: File name exists - NAV_FILE_ERROR_FILE_NAME_EXISTS
    -5,     // Test 4: Disk I/O error (parent doesn't exist)
    ...
    -2,     // Test 11: Invalid operation
    -8,     // Test 12: File name exists (directory already exists)
...
constant char DIRECTORY_CREATE_VERIFY_EXISTS[] = {
    ...
    false,  // Test 3: Already exists (failed creation)
    false,  // Test 4: Should not exist (creation failed)
    ...
    false,  // Test 11: Root always exists (but creation should fail)
    false,  // Test 12: Already exists (failed creation)
